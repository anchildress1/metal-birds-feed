...
- Norway: source data from Luftfartstilsynet (Civil Aviation Authority of Norway), Norges luftfartøyregister — [data.norge.no](https://data.norge.no/datasets/ca241ae5-fc9e-3702-bbcd-5453d2d0f06f); published as public open data on Norway's national open-data portal, normalized into this project schema without implying endorsement. No warranty of accuracy or completeness is given.
