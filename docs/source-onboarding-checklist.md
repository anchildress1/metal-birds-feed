...
| CAA Lebanon (formerly DGCA) | 2026-05-10 (v2 to `info@caa.gov.lb`) | 2026-06-09 | info@caa.gov.lb cc contact@caa.gov.lb (new authority domain; v1 to ~~info@dgca.gov.lb~~ bounced — `dgca.gov.lb` has no working email; agency restructuring into General Authority of Civil Aviation per MPWT May 2025) | **Yes** (Unknown; public-record fallback after follow-up) |
