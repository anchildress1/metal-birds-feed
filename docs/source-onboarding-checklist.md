...
| CAAS Singapore   | Open + attribution — CAAS reply 2026-05-12 (CHAI Kwan Kua, QSM): register "publicly accessible and free to be used"; attribute to CAAS + link | Engineering only — public monthly XLSX verified 2026-07-05 (242 rows: reg 9V-/serial/model/operator/mfr/engine; operator-only, no owner PII, no ICAO hex) on the Isomer CDN, discovered from the CAAS register page (`discover_url`/`discover_pattern`).                                                                                                  | 2026-05-12           |
