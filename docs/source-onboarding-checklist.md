...
| ANAC Angola               | 2026-05-11 (v1 to ~~anac@anac.co.ao~~ + ~~reclamacoes@anac.co.ao~~ bounced — `.co.ao` domain is NXDOMAIN; v2 sent 2026-05-11 to verified `anac@anac.ao` cc `sec.anac.ao@gmail.com`) | 2026-06-10 | anac@anac.ao cc sec.anac.ao@gmail.com (verified on anac.ao/ao/contactos; INAVIC merged into ANAC Angola; D2- prefix; phone +244 921 320 429 / +244 921 320 442; the legacy inavic.gov.ao/contactos page still publishes the stale `.co.ao` addresses) | **Yes** (Unknown; public-record fallback after follow-up) |
