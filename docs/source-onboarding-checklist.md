...
| Közlekedési Hatóság (HU)   | Not specified ("Minden jog fenntartva") — treated as Private-use, CC.2 fallback elapsed 2026-06-09 | Live — `pdf` parser path; stable Liferay latest-version URL, ~weekly; no ICAO hex                                             |
