...
| Lithuania         | TKA                | [data.gov.lt: dataset 2735](https://data.gov.lt/datasets/2735/)                                                                                    | Spinta API JSON (paginated cursor); PII pre-stripped — owner/operator types only                                 | Unknown — leans Open       | data.gov.lt portal default is CC BY 4.0 but dataset-specific declaration not directly verified         | **Yes** (sent 2026-05-09; license confirmation only; follow-up 2026-06-08)                    | joris.dumcius@tka.lt (cc info@tka.lt; head of Aircraft Section)                              |
