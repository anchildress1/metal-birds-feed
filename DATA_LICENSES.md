...
- Public-domain, CC0, and open-government sources without a mandated notice are courtesy-credited by `src/service/attributions.ts`; this tracker records only their correspondence, storage/cache posture, and status.
