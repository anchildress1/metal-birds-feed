...
| CCAA | Croatia | n/a | 2026-05-10 | none (30-day fallback elapsed 2026-06-09) | live: private-use via CC.2 fallback, no license stated; monthly pdf, no ICAO hex |
...
| Közlekedési Hatóság | Hungary | n/a | 2026-05-10 | none (30-day fallback elapsed 2026-06-09) | live: private-use via CC.2 fallback, no license stated; ~weekly pdf, no ICAO hex |
...
| TKA | Lithuania | n/a | 2026-05-10 | none (auto-ack only) | paused 2026-09-10: open (CC BY 4.0 via data.gov.lt), no reply needed; data.gov.lt WAF-blocking all access |
...
- au-casa: "Civil Aviation Safety Authority (CASA), Australia, licensed under CC BY 4.0"
- br-anac: "Source: Agência Nacional de Aviação Civil (ANAC), Brazil"
- cl-dgac: "Dirección General de Aeronáutica Civil (DGAC) of Chile — the sole official source and copyright holder of the information — https://www.dgac.gob.cl/aeronaves-2/registro-nacional-de-aeronaves/"
- ee-tram: "The data is provided without guarantees of completeness, accuracy, or uninterrupted availability."
- es-aesa: "Data source: Agencia Estatal de Seguridad Aérea (AESA)"
- lt-tka: "Transporto kompetencijų agentūra (Transport Competence Agency), Lithuania — Civilinių orlaivių registro duomenys, licensed under CC BY 4.0"
- mv-caa: "Whilst reasonable care is taken compiling the data, the CAA does not warrant it is free of error or omission."
- nz-caa: "Civil Aviation Authority of New Zealand"
- sg-caas: "Civil Aviation Authority of Singapore — https://www.caas.gov.sg/industry/aircraft-operators/certificate-of-registration/"
- tc-ca: "Reproduced and distributed with the permission of the Government of Canada."
- tc-ca: "This product has been produced by or for Ashley Childress and includes data provided by the Government of Canada. The incorporation of data sourced from the Government of Canada within this product shall not be construed as constituting an endorsement by the Government of Canada of our product."
- tw-caa: "Source: Civil Aviation Administration, MOTC R.O.C. — caa.gov.tw. Licensed under the Open Government Data License, v1.0."

## Source Posture

Clearance basis, conditions, and residual exposure per active source. The served credit line is `src/service/attributions.ts`; it is not repeated here.

- au-casa: CC BY 4.0 site-wide licence. Attribution to the licensor and identification of the licence are licence conditions, not courtesy.
- br-anac: open data requiring no prior authorization, but citation is a condition of use — "proper citation of the source is mandatory" and the data "may be used freely, provided that the source is appropriately cited" (Brazilian Aeronautical Registry Technical Branch, reply 2026-05-12). No wording was prescribed, so the citation itself is what must survive.
- ch-foca: redistribution confirmed in writing by FOCA (2026-05-22); attribution required.
- cl-dgac: reusable non-commercially under Ley N° 17.336 (Chilean Intellectual Property Law); DGAC retains copyright. Strict and non-waivable condition (Felipe Armijo Cadena reply 2026-07-22): DGAC cited as sole official source and copyright holder, with a link to the institutional website. Non-commercial research and reference use only; commercial deployment requires separate written permission.
- ee-tram: reuse and redistribution permitted for non-commercial use (reply 2026-05-13), carrying the agency's own no-guarantees disclaimer.
- es-aesa: reusable under Real Decreto 1495/2011 (developing Ley 37/2007 on public-sector-information reuse); conditions require the source of origin be cited, the meaning not be distorted, and the update-date/reuse-condition metadata be preserved.
- faa: a work of the US federal government, public domain, Open under CC.1. No restriction on reuse, storage, or redistribution, and no permission email required. Credited by courtesy, not by condition.
- hr-ccaa: no license stated on the register page. The only terms found are an accuracy/completeness disclaimer ("The Agency does not guarantee the completeness and accuracy of data in the table after it is published... users are instructed to address the Agency and check the precise data in the manually kept main book") and nothing restricting reuse, caching, or redistribution — Private-use under CC.1. Shipped on the §CC.2 fallback (sent 2026-05-10, elapsed 2026-06-09, no reply). Coverage cost: no ICAO 24-bit hex published, so its rows answer tail-number lookups only.
- hu-kh: no license stated; the only term is the site-wide "Minden jog fenntartva ©" (all rights reserved) in the Impresszum, with nothing restricting reuse, caching, storage, or automated access — Private-use under CC.1. Shipped on the §CC.2 fallback (sent 2026-05-10 to the Légügyi Felügyeleti Hatósági Főosztály, elapsed 2026-06-09, no reply). Residual exposure: "all rights reserved" is broader than the use made of it. Coverage cost: no ICAO 24-bit hex published, so its rows answer tail-number lookups only.
- lt-tka: published on the national open-data portal under CC BY 4.0 (`https://creativecommons.org/licenses/by/4.0/deed.lt`, recorded against the dataset on data.europa.eu), so attribution, licence identification, and indication of changes are licence conditions. Cleared on the public licence — no agency reply required, and none came (delivered to info@tka.lt 2026-05-10, auto-acknowledgement only). Coverage cost: no ICAO 24-bit address published, so its rows answer tail-number lookups only and are unreachable from an ADS-B blip. Access paused 2026-09-10: data.gov.lt returns an Imperva "URL has been blocked" page on a 500 to GitHub runners and bare residential IPs alike, reachable over VPN only. The licence is unchanged and the last good slice keeps serving; a network block, not a terms problem. Refresh is manual from a VPN-connected machine until CI gains an egress path, and the staleness issue escalates on its own threshold with nothing able to clear it.
- lv-caa: CC0-1.0, Open under CC.1. No condition beyond the courtesy credit, and no permission email required. The bulk register publishes no owner identity, so `owner`/`operator` carry country only.
- mv-caa: attribution is welcomed rather than required — "Attribution - would be nice" — but the error statement is the stated condition: "We feel it would be important to include a statement on errors similar to the one on our register" (Abdulla Mohamed, Director Airworthiness, reply 2026-05-11).
- nl-ilt: CC-0 (public domain) per data.overheid.nl, Open under CC.1. No condition beyond the courtesy credit, and no permission email required. The bulk register publishes no owner identity, so `owner`/`operator` carry country only.
- no-caa: no license specified by the agency ("Ikke oppgitt"), Private-use under CC.1; the posture must be stated rather than implied.
