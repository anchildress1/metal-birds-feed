...
- **Bulk download URL:** Monthly binary `.xls` attachment discovered from the current ROC-year page (`sources/tw-caa.yaml` uses `discover_url: https://www.caa.gov.tw/article.aspx?a=4499&lang=1` plus `../FileAtt.ashx?lang=1&id=...` capture). Verified during ingest implementation.
...
- **Update cadence:**
  - **Stated (per CAAT 2026-05-21):** twice per year, normally **January and June**.
  - **Observed (per public PDF history on `caat.or.th/wp-content/uploads/...`):** roughly **annual**, with mid-year drops in **July** (not June) when they happen. Visible file dates: 2020-12-31, 2022-01-07, 2023-01-30, 2024-07-08, 2025-01-08, 2026-01-14. The only clean six-month cycle on record is Jul 2024 → Jan 2025; Jul 2025 was skipped.
