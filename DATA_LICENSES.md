...
- Transport Canada: the Government of Canada open licence mandates both the reproduction notice and the value-added notice; both must reach the consumer together. Required citation, verbatim (tc-ca): "Reproduced and distributed with the permission of the Government of Canada."
...
- CASA Australia: CC BY 4.0 site-wide licence; attribution to the licensor and identification of the licence are conditions of the licence, not courtesy. Required citation, verbatim (au-casa): "Civil Aviation Safety Authority (CASA), Australia, licensed under CC BY 4.0"
- CAA Maldives: attribution is welcomed rather than required — "Attribution - would be nice" — but the error statement is the stated condition: "We feel it would be important to include a statement on errors similar to the one on our register" (Abdulla Mohamed, Director Airworthiness, reply 2026-05-11). Required citation, verbatim (mv-caa): "Whilst reasonable care is taken compiling the data, the CAA does not warrant it is free of error or omission."
- CAAS Singapore: Civil Aviation Authority of Singapore source data, free to use with attribution to CAAS and a link to its register page (https://www.caas.gov.sg/industry/aircraft-operators/certificate-of-registration/); normalized into this project schema; no endorsement implied. Required citation, verbatim (sg-caas): "Civil Aviation Authority of Singapore — https://www.caas.gov.sg/industry/aircraft-operators/certificate-of-registration/"
- AESA Spain: reusable under Real Decreto 1495/2011 (developing Ley 37/2007 on public-sector-information reuse); conditions require the source of origin be cited, the meaning not be distorted, and the update-date/reuse-condition metadata be preserved. Required citation, verbatim (es-aesa): "Data source: Agencia Estatal de Seguridad Aérea (AESA)". Normalized into this project schema; no endorsement implied.
- DGAC Chile: reusable non-commercially under Ley N° 17.336 (Chilean Intellectual Property Law); DGAC of Chile retains copyright. Strict and non-waivable condition (DGAC verbatim, Felipe Armijo Cadena reply 2026-07-22): the Dirección General de Aeronáutica Civil (DGAC) of Chile must be cited as the **sole official source and copyright holder** of the information, with a link to the institutional website (https://www.dgac.gob.cl/aeronaves-2/registro-nacional-de-aeronaves/). Non-commercial research and reference use only; commercial deployment requires separate written permission. Normalized into this project schema; no endorsement implied. Required citation, verbatim (cl-dgac): "Dirección General de Aeronáutica Civil (DGAC) of Chile — the sole official source and copyright holder of the information — https://www.dgac.gob.cl/aeronaves-2/registro-nacional-de-aeronaves/"
- CAA New Zealand: terms grant reproduction **for personal use**, conditioned (verbatim) on "the material being reproduced accurately and not being used in a misleading context" and on acknowledgement — "In all cases, the CAA must be acknowledged as the source." Required credit, verbatim (nz-caa): "Civil Aviation Authority of New Zealand". No storage/caching prohibition, so the §CC.5 gate passes; the open question is whether a private operator pipeline counts as "personal use." Shipped on the §CC.2 fallback (sent 2026-05-05, elapsed 2026-06-04, no reply) — the weakest fallback clearance held, since unlike Norway's silence CAA NZ actively directs non-personal reuse to a permission request. NZGOAL is not adopted on the CAA site. Revisit on any reply.
- FOCA / BAZL Switzerland: redistribution confirmed in writing by FOCA (2026-05-22); attribution required. Served verbatim (ch-foca): "Source data from the Federal Office of Civil Aviation (FOCA / BAZL), Switzerland — https://app02.bazl.admin.ch/web/bazl/en/; redistribution confirmed by FOCA, normalized into this project schema without implying endorsement."
- Transpordiamet Estonia: reuse and redistribution permitted for non-commercial use (reply 2026-05-13), carrying the agency's own no-guarantees disclaimer. Served verbatim (ee-tram): "Data source: Estonian Transport Administration (Transpordiamet) — https://transpordiamet.ee/ohusoidukite-register; reused and redistributed with permission for non-commercial use, normalized into this project schema without implying endorsement. The data is provided without guarantees of completeness, accuracy, or uninterrupted availability."
...
- CCAA Croatia: no license stated on the register page; the only terms found are an accuracy/completeness disclaimer ("The Agency does not guarantee the completeness and accuracy of data in the table after it is published... users are instructed to address the Agency and check the precise data in the manually kept main book") and no term restricting reuse, caching, or redistribution — treated as Private-use under CC.1. Shipped on the §CC.2 fallback (sent 2026-05-10, elapsed 2026-06-09, no reply). Served verbatim (hr-ccaa): "Source data from the Croatian Civil Aviation Agency (CCAA) — https://www.ccaa.hr/en/list-of-registered-aircraft-94674; publicly accessible with no specified license and treated as Private-use, normalized into this project schema without implying endorsement." Coverage cost: the register publishes no ICAO 24-bit hex, so its rows answer tail-number lookups only.
- Közlekedési Hatóság Hungary: no license stated on the authority's site; the only term is the site-wide "Minden jog fenntartva ©" (all rights reserved) in the Impresszum, with no statement restricting reuse, caching, storage, or automated access, and no terms page attached to the register document itself — treated as Private-use under CC.1. Shipped on the §CC.2 fallback (sent 2026-05-10 to the Légügyi Felügyeleti Hatósági Főosztály, elapsed 2026-06-09, no reply). Residual exposure: "all rights reserved" is broader than the private operator use made of it, and a future reply could narrow or withdraw the posture. Served verbatim (hu-kh): "Source data from the Közlekedési Hatóság (Hungarian Transport Authority), Magyarország Légijármű Lajstroma — https://www.kozlekedesihatosag.kormany.hu/hu/dokumentum/104604; publicly accessible with no specified license and treated as Private-use, normalized into this project schema without implying endorsement." Coverage cost: the register publishes no ICAO 24-bit hex, so its rows answer tail-number lookups only.
...
- Közlekedési Hatóság Hungary: **weekly.** The authority declares no cadence; the document library reported version 321 of the register on 2026-09-11 against a 2020-08-14 creation date, and every page carries its own "Frissítési dátum / Updated" stamp. That works out near-weekly, so the refresh runs at 7 days rather than the monthly rhythm a register PDF usually implies.
